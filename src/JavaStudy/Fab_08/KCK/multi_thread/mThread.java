...
class runnerThread implements Runnable {//달리기 주자 쓰레드
    ...
    public runnerThread(int number) {//생성자
        this.number = number;
    }
//
...
public class mThread {//main 쓰레드
    ...
    public static void main(String[] args) {
        ...
        Thread a = new Thread(new runnerThread(1));     //주자 1역할을 하는 쓰레드 a ~ 4역할을 하는 쓰레드 d
        Thread b = new Thread(new runnerThread(2));
